...
ENDC
IF DEF(_GREEN)
	RGB 31,29,31, 30,30,17, 21,00,04, 17,23,10 ; PAL_LOGO1  TODO: This is made up
ENDC
IF DEF(_BLUE)
...
ENDC
IF DEF(_GREEN) ;  TODO: This is made up
	RGB 31,29,31, 31,31,17, 16,29,19, 03,02,02 ; PAL_SLOTS2
	RGB 31,29,31, 22,31,16, 16,29,19, 03,02,02 ; PAL_SLOTS3
	RGB 31,29,31, 25,17,21, 16,29,19, 03,02,02 ; PAL_SLOTS4
ENDC
IF DEF(_BLUE)
